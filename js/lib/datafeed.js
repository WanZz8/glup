...
Datafeeds.UDFCompatibleDatafeed = function (datafeedURL, updateURL, updateFrequency) {
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
    ...
    let url = val === 600 ? '/quote/quota.jsp' : this._datafeedURL + this._historyURL;
    ...
    if(val === 600){
        this._send(this._updateURL + '/quota.jsp',{
            ...
            if (arg.status === 200) {
                dataCB(arg.responseText,onDataCallback,onErrorCallback);
            } else {
        ...
        this._send(this._datafeedURL + this._historyURL, {
            ...
            dataCB(response,onDataCallback,onErrorCallback);
        }).fail(function (arg) {
            if (arg.status === 200) {
                dataCB(arg.responseText,onDataCallback,onErrorCallback);
            } else {
